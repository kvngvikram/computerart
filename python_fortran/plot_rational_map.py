#!/usr/bin/env python
from fortran_subroutines import julia_set_rational_map
...
def replot(min_x, max_x, min_y, max_y, axis):
    data = julia_set_rational_map(
        min_x, max_x, min_y, max_y, x_res, y_res, c, max_iter, escape_rad)
    axis.clear()
